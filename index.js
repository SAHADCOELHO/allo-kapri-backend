...
// 1) Home simples para não dar "Cannot GET /"
app.get("/", (_req, res) => {
  res.json({ ok: true, service: "allo-kapri-backend", endpoints: ["/healthz", "/api/catalog"] });
});

// 2) (Opcional) Servir estáticos da pasta public
